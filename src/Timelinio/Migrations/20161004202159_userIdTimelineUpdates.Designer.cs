...
namespace Timelinio.Migrations
{
    ...
    [Migration("20161004202159_userIdTimelineUpdates")]
    partial class userIdTimelineUpdates
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Timelinio.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Timelinio.Models.ApplicationUser")
                        .WithMany("Claims")
